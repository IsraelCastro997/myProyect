...
<section>
    <div class="container text-center">
        <form action=" /profileAcademic " method="post" class="form-horizontal" enctype="multipart/form-data">
        @csrf
        <div class="row">


            <div class="container text-center">
                <h2 class="mb-0">Edita tus datos de Academico</h2>
                <br>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8 mb-5">
                        <div class="p-4 mb-3 bg-danger text-white">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <input type="text" id="name_academic" name="name_academic" class="form-control"  required="true" value="{{$user->academic->name_academic}}">
                                    <label class="font-weight-bold" for="paternalSurname">Apellido Paterno</label>
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    <input type="text" id="paternal_surname_academic" name="paternal_surname_academic" class="form-control"  required="true" value="{{$user->academic->paternal_surname_academic}}">
                                    <label class="font-weight-bold" for="maternalSurname">Apellido Materno</label>
                                    <input type="text" id="maternal_surname_academic" name="maternal_surname_academic" class="form-control"  required="true" value="{{$user->academic->maternal_surname_academic}}">
                                </div>
                            </div>
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 mb-3 mb-md-0">
                                    ...
                                    <input type="number" id="phone_academic" name="phone_academic" class="form-control"  required="true" value="{{$user->academic->phone_academic}}">
                                </div>
                            </div>
                                ...
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                                        ...
                                        <form action=" /eliminarAcademico " method="get" class="form-horizontal">
